(() => {
    ...
    let getWeatherCurrentLocation = async (position) => {
        let lat = position.coords.latitude;
        let lon = position.coords.longitude;
        try {
            let response = await fetch("https://api.openweathermap.org/data/2.5/forecast?lat="+lat+"&lon="+lon+"&units=metric&appid=2ef359fbac037127dbef3b700cdb7730");
            ...
            alert("Can't display weather current location.")
            console.log(error);
        }
    }
